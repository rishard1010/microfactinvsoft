...
public class CORSFilter implements ContainerResponseFilter {
    ...
    public final static String DEFAULT_ALLOWED_HEADERS = "authorization,origin,accept,content-type";
    public final static String DEFAULT_EXPOSED_HEADERS = "authorization,location,info";
